...
map <- "boston"
this_dir <- "temp/boston"

this_place <- st_read("https://bostonopendata-boston.opendata.arcgis.com/datasets/boston::city-of-boston-boundary.geojson?where=1=1&outSR=%7B%22latestWkid%22%3A2249%2C%22wkid%22%3A102686%7D")
this_place |> 
  ggplot() +
  geom_sf()
